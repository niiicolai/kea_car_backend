...
colors_router: APIRouter = APIRouter()

def get_db():
    with get_db_session() as session:
        yield session

@colors_router.get("/colors", response_model=list[ColorReturnResource])
...
@colors_router.get("/color/{color_id}", response_model=ColorReturnResource)
...
@colors_router.post("/color", response_model=ColorReturnResource)
...
#@colors_router.put("/color/{color_id}", response_model=ColorReturnResource)
...
#@colors_router.delete("/color/{color_id}", response_model=ColorReturnResource)
